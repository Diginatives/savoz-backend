...
exports.customUserCollectionResponse = exports.customUserResponse = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            userObj = {
                ...
                cardId: data.cardId || '',
                avatar: data.avatar
                    ? (0, utils_1.getHomeUrl)(urls_1.default.values.imageLiveUrl) + data.avatar
...
exports.customUserResponse = customUserResponse;
function customUserCollectionResponse(data) {
    return __awaiter(this, void 0, void 0, function () {
        var users, i, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    _b = (_a = users).push;
                    return [4 /*yield*/, customUserResponse(data[i])];
                case 2:
                    _b.apply(_a, [_c.sent()]);
                    _c.label = 3;
                case 3:
...
exports.customUserCollectionResponse = customUserCollectionResponse;
