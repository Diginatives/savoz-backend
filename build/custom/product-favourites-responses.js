...
exports.customFavouriteCollectionResponse = exports.customFavouriteResponse = void 0;
var urls_1 = __importDefault(require("../constants/urls"));
var utils_1 = require("../function/utils");
function customFavouriteResponse(data) {
        ...
        return __generator(this, function (_a) {
            userObj = {
                ...
                productCategoryImage: data.productCategoryImage
                    ? (0, utils_1.getHomeForImage)(urls_1.default.values.imageCategoryLiveUrl) + data.productCategoryImage
                    : "".concat((0, utils_1.getHomeUrl)(urls_1.default.values.imageDummyLiveUrl), "default_sub_category.png"),
...
exports.customFavouriteResponse = customFavouriteResponse;
function customFavouriteCollectionResponse(data) {
    return __awaiter(this, void 0, void 0, function () {
        var favs, i, _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    ...
                    _b = (_a = favs).push;
                    return [4 /*yield*/, customFavouriteResponse(data[i])];
                case 2:
                    _b.apply(_a, [_c.sent()]);
                    _c.label = 3;
                case 3:
                    i++;
                    return [3 /*break*/, 1];
                case 4: return [2 /*return*/, favs];
            }
        });
    });
}
exports.customFavouriteCollectionResponse = customFavouriteCollectionResponse;
//# sourceMappingURL=product-favourites-responses.js.map