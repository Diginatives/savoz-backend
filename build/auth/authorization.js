...
exports.default = router.use((0, asyncHandler_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var role;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, EmployeeRepo_1.default.findByRoleId(req['userId'])];
            case 1:
                role = _a.sent();
                if (!role || role.length === 0)
                    throw new ApiResponse_1.BadRequestResponse('Permission denied').send(res);
