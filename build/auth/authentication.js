...
exports.default = router.use((0, validator_1.default)(schema_1.default.auth, validator_1.ValidationSource.HEADER), (0, asyncHandler_1.default)(function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var payload, user, type, keystore, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                ...
                user = void 0;
                type = void 0;
                if (!(payload.ct === roles_1.default.USER)) return [3 /*break*/, 4];
                return [4 /*yield*/, UserRepo_1.default.findById(payload.sub)];
            case 3:
                user = _a.sent();
                type = roles_1.default.USER;
                return [3 /*break*/, 6];
            case 4: return [4 /*yield*/, EmployeeRepo_1.default.findById(payload.sub)];
            case 5:
                user = _a.sent();
            ...
            case 6:
                ...
                return [4 /*yield*/, KeystoreRepo_1.default.findforKey(req['userId'], payload.prm)];
            case 7:
                keystore = _a.sent();
            ...
            case 8:
                e_1 = _a.sent();
                if (e_1 instanceof ApiError_1.TokenExpiredError)
                    throw new ApiError_1.AccessTokenError(e_1.message);
                throw e_1;
