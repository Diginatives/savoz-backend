...
/*-------------------------------------------------------------------------*/
router.delete('', (0, asyncHandler_1.default)(function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var roleId, type;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                roleId = req['roleId'];
                if (roleId === roles_1.default.USERID)
                    type = roles_1.default.USER;
                else
                    type = roles_1.default.EMPLOYEE;
                return [4 /*yield*/, KeystoreRepo_1.default.remove(req.keystore.id, type)];
            case 1:
                _a.sent();
