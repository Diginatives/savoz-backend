...
var CategoryRepo = /** @class */ (function () {
    function CategoryRepo() {
    }
    // contains critical information of the user
    CategoryRepo.createSubCategory = function (obj) {
        return __awaiter(this, void 0, void 0, function () {
            var res;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, __1.insertRecord)(SubCategory_1.SUB_CATEGORY_TABLE_NAME, obj)];
                    case 1:
                        res = _a.sent();
                        return [2 /*return*/, { subCategory: res }];
                }
            });
        });
    };
    CategoryRepo.findByType = function (type) {
        return __awaiter(this, void 0, void 0, function () {
            var query;
            return __generator(this, function (_a) {
